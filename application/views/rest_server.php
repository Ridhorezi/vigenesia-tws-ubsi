    ...
    <div id="container">
        ...
        <div id="body">
            ...
            <ol>
                ...
                <li><a href="<?php echo site_url('/vigenesia/api/v1/user'); ?>">GET DATA USER</a> - defaulting to JSON</li>
                <li><a href="<?php echo site_url('/vigenesia/api/v1/putprofile'); ?>">PUT UNTUK Profile</a> - defaulting to JSON</li>
                <li><a href="<?php echo site_url('/vigenesia/api/v1/auth/registrasi'); ?>">POST UNTUK PENDAFTARAN MEMBER</a> - defaulting to JSON</li>
                <li><a href="<?php echo site_url('/vigenesia/api/v1/auth/login'); ?>">POST UNTUK LOGIN</a> - defaulting to JSON</li>
            ...
            <ol>
                ...
                <li><a href="<?php echo site_url('/vigenesia/api/v1/postmotivasi'); ?>">POST UNTUK motivasi</a> - defaulting to JSON</li>
                <li><a href="<?php echo site_url('/vigenesia/api/v1/putmotivasi'); ?>">PUT UNTUK Update motivasi</a> - defaulting to JSON</li>
                <li><a href="<?php echo site_url('/vigenesia/api/v1/motivasi'); ?>">GET UNTUK motivasi</a> - defaulting to JSON</li>
                <li><a href="<?php echo site_url('/vigenesia/api/v1/deletemotivasi'); ?>">Delete UNTUK motivasi</a> - defaulting to JSON</li>
            </ol>
